...
public class Bus {
    ...
    // Other fields: arrivalDate, departureDate, etc.

    @Version // Enables optimistic locking on Bus too
    private int version;
    ...
    public Bus(LocalDate departureDate,int availableSeats,int version,LocalTime departureTime, String boardingPoint,
